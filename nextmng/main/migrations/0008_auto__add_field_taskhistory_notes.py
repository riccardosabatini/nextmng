...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskHistory.notes'
        db.add_column(u'main_taskhistory', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskHistory.notes'
        db.delete_column(u'main_taskhistory', 'notes')
    ...
    models = {
        ...
        u'main.taskhistory': {
            'Meta': {'ordering': "['finished']", 'object_name': 'TaskHistory'},
